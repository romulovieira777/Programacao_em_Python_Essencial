...
def faz_me_rir():
    def rir():
        return choice(('hahahahahahaha', 'kkkkkkkkkkkk', 'yayayayayayayaya'))
    return rir
...
def faz_me_rir_novamente(pessoa):
    def dando_risada():
        risada = choice(('hahahahahaha', 'kkkkkkkkkkkkk', 'yayayayayayayaya'))
...
rindo = faz_me_rir_novamente('Felicty')
