...
pais = paises.get('br', 'Não encontrei o país')
...
# Tuplas por exemplo são bastante interessantes de serem utilizados como chave de dicionários, pois as mesmas
# são imutáveis.
...
produto1 = ['PlaySation 4', 1, 2300.00]
...
# Forma 2 - Poderíamos utilizar uma tupla para isso? sim
...
# Forma 3 - Poderíamos utilizar um Dicionário para isso? sim

carrinho = []

produto1 = {'nome': 'Playsatation 4', 'quantidade': 1, 'preco': 2300.00}
