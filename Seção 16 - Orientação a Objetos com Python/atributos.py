...
# valores como é o caso dos atributos de instância, como os atributos de classe todas as instâncias
...
print(p2.valor)  # Aceeso possível, mas incorreto de um atributo de classe
