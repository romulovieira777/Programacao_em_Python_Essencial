...
conta1._Conta__titular = 'Felicity'
...
class Conta:
    ...
    def transferir(self, valor, conta_destino):
        ...
        self.__saldo -= 10  # Taxa de transfrência paga por quem realizou a transferência


# Testando

conta1 = Conta('Angelina', 300, 2000)
conta1.extrato()
