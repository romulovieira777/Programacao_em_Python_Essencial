...
Classes podem conter:
    ...
    iríamos querer saber se a lâmpada é 100 ou 220 volts, se ela é branca, amarela, vermelha ou
...
OBS: Quando nomeamos nossas classes em Python utilizamos por convênção o nome com inicila em
maiúsculo. Se o nome for composto, utiliza-se as inicias de ambas as palavras em maiúsculo, todas juntas.
