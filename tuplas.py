...
# CONCLUSÂO: Podemos concluir que tuplas são definadas pela vírgula e não pelo uso do parênteses
...
tupla = ('Geek University', 'Programação em Pthon: Essencial')
...
tupla = tupla1 + tupla2  # Tuplas são imutáveis, mas podemos sobrescrever seus valores
print(tupla1)
