...
# Podemos contar facilmente o número de ocorências de um valor em uma lista
...
# Podemos fazer uma busca de um range, inicio/fim
...
# é chamdo de Deep Copy (Cópia profunda)
