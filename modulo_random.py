...
# OBS: Ao utilizar o import de todo o módulo, todas as funções, atributos, classes e propriedades que estiverem
# dentro do módulo ficarão disoníveis (Ficarão em Memória). Caso você saiba quais funções você precisa
# utilizar deste módulo, então esta não seria a forma ideal de utilização. Nós veremos uma forma melhor na Forma 2.
