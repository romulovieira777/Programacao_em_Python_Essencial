...
square_meters = float(input('Enter the value in square meters: '))
acre = round(square_meters * 0.0001, 2)
print(f'The value of {square_meters} square meters for acre is {acre}!')
