...
bloco_da_funcao -> Também chamdo de corpo da função ou implementação, é onde o processamento da função acontece.
...
# Em Python, podemos inclusive criar variáveis do tipo de uma funçao e executar esta função através da variável
